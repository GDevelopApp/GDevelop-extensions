  ...
  it('renders events as text', () => {
    ...
    try {
      ...
      const serializedEvents = [
        ...
        // ForEach event with orderBy, order, and limit
        {
          type: 'BuiltinCommonInstructions::ForEach',
          object: 'MySpriteObject',
          orderBy: 'MySpriteObject.X()',
          order: 'desc',
          limit: '3',
          conditions: [],
          actions: [
        ...
        // ForEach event with orderBy, ascending, no limit
        {
          type: 'BuiltinCommonInstructions::ForEach',
          object: 'MySpriteObject',
      ...
      expect(
        ...
        <event-5 type=\\"for-each\\">
         Repeat these separately for each instance of MySpriteObject ordered by \`MySpriteObject.X()\` descending, limit \`3\`:
         Conditions:
          (no conditions)
         Actions:
          - Show MySpriteObject
        ...
        <event-6 type=\\"for-each\\">
         Repeat these separately for each instance of MySpriteObject ordered by \`MySpriteObject.Variable(Score)\` ascending:
         Conditions:
          (no conditions)
         Actions:
          (no actions)
